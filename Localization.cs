...
namespace TCPTunnel
{
    ...
    internal enum TextId
    {
        ...
        CurrentNickname, GraphicsOptions, Exit, LanguageMenu,
        PingArgument, ConnectArgument, ServerAlive, ServerDead,
        ChangeNicknameWelcome, ChangeIdentity, EnterNewNickname, CheckingName,
        NicknameRules, TryAgain, IdentityUpdated, GoodName, TookYourTime,
    ...
    internal static class Lang
    {
        private static readonly Dictionary<TextId, LocalizedText> catalog =
            new Dictionary<TextId, LocalizedText>
            {
                ...
                { TextId.CurrentNickname, T("Ваш текущий псевдоним: {0}", "Current nickname: {0}") },
                ...
                { TextId.TookYourTime, T("Долго придумывали :) ", "That took a while :) ") },
                ...
                { TextId.ConnectedCommands, T("Подключено к {0}. Команды: /status, /stop, /exit.", "Connected to {0}. Commands: /status, /stop, /exit.") },
